...
echo form_open_multipart('persuratan/form/tindaklanjut/disposisi?'.$query_link, ['class'=>'form', 'id'=>'form_tindaklanjut_surat'.$id])?>
	<div class="row">
					...
					<div class="card-body">
						<div class="row mb-2">
							<div class="col-sm-12 col-md-12">
								<div class="rounded color-yellow-light p-2 shadow">
									<div class="border rounded p-2 color-yellow mb-1">
										<b><?=$data_tindaklanjut->status_name?></b> dari <b><?=$data_tindaklanjut->pengirim_nama?> [<i class="fw-normal"><?=$data_tindaklanjut->pengirim_jabatan_name?> (<?=$data_tindaklanjut->pengirim_unit_name?>)</i>]</b>, Pada <?=$data_tindaklanjut->sent_time?>
									</div>
	                                <div class="border rounded p-2 color-abu">
	                                    <b class="d-block">Keterangan/Catatan/Disposisi:</b>
	                                    <?=$data_tindaklanjut->value?>
	                                    <?=$data_tindaklanjut->catatan?>
	                                    <?php if($data_tindaklanjut->lampiran){?>
	                                        <div>
	                                            <?php $lampiranExp = explode(',', $data_tindaklanjut->lampiran);
						...
						<div class="row mb-2 div-penerima">
							<div class="col-sm-12 col-md-12">
								...
								<input type="hidden" name="id_tl" id="id_tl" value="<?=(isset($data_tindaklanjut))?string_to($data_tindaklanjut->id,'encode'):0?>">
							</div>
						</div>
