			...
			<div class="card-body">
				...
				<div class="table-responsive">
					<table class="table table-striped table-hover table-bordered">
						<thead>
							<tr>
								<th class="text-center color-yellow-amber" colspan="4">Berikut Informasi Saldo Cuti</th>
							</tr>
							<tr>
								<th class="text-center color-yellow-amber">Tahun</th>
								<th class="text-center color-yellow-amber">Saldo Awal</th>
								<th class="text-center color-yellow-amber">Digunakan</th>
								<th class="text-center color-yellow-amber">Sisa</th>
							</tr>
						</thead>
						<tbody>
